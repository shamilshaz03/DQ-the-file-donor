...
〇 Tᴏᴛᴀʟ Usᴇʀs: <code>{}</code>
〇 Tᴏᴛᴀʟ Cʜᴀᴛs: <code>{}</code>

Pʀɪᴍᴀʀʏ Dᴀᴛᴀʙᴀsᴇ Sᴛᴀᴛɪsᴛɪᴄs 
〇 Tᴏᴛᴀʟ Fɪʟᴇs: <code>{}</code>
〇 Usᴇᴅ Sᴛᴏʀᴀɢᴇ: <code>{} MB</code>
〇 Fʀᴇᴇ Sᴛᴏʀᴀɢᴇ: <code>{} MB</code>
...
• ɢʀᴏᴜᴘ : @Cinema_Collection_Officiall
• ɢʀᴏᴜᴘ : @Cinema_Collection_Officiall
</b>"""
...
=========== • ✠ • ===========
▫️ ᴄʜᴀɴɴᴇʟ : @movie_update_ott
▫️ ɢʀᴏᴜᴘ : @Cinema_Collection_Officiall
=========== • ✠ • ===========</b>"""
